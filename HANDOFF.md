...
- Updated (2026-08-14): office actions now open a pre-call modal with the recipient extension, then place a raw `tel:0315203` office call on confirmation.
- Updated (2026-08-14): office modal now identifies the selected contact by role and name before showing the extension.
- Updated (2026-08-14): replaced the office modal title/name lines with a compact contact card containing a silhouette, bold name, and smaller role.
